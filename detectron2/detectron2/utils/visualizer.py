...
class Visualizer:
    ...
    def draw_instance_predictions(self, predictions):
        ...
        if predictions.has("pred_diameter"):
            diameters = predictions.pred_diameter
    ...
    def overlay_instances(
        ...
        *,
        ...
        if diameters is not None:
            assert len(diameters) == num_instances
        ...
        if areas is not None:
            ...
            diameters = diameters.cpu().numpy()*10
            diam = []
            if diameters is not None:
                for k in sorted_idxs:
                    diam.append(diameters[k][0])
